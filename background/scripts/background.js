                    ...
                    if (extracted && extracted.src) {
                        ...
                        if (extracted.metadata) {
                            if (extracted.metadata.thumbnail)
                                request.data.thumbnail = extracted.metadata.thumbnail;
                            if (extracted.metadata.duration)
                                request.data.duration = extracted.metadata.duration;
                            if (extracted.metadata.title)
                                request.data.title = extracted.metadata.title;
                            if (extracted.metadata.tags && extracted.metadata.tags.length > 0)
                                request.data.tags = extracted.metadata.tags;
                            if (extracted.metadata.author)
                                request.data.author = extracted.metadata.author;
                            if (extracted.metadata.views)
                                request.data.views = extracted.metadata.views;
                            if (extracted.metadata.likes)
                                request.data.likes = extracted.metadata.likes;
                            if (extracted.metadata.date)
                                request.data.date = extracted.metadata.date;
                        }
                    }
                }
